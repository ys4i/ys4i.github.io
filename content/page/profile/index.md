...
-->
<!-- 試作から製品化・展示まで、プロダクトを体験として仕上げます。

意図を技術に変換

回路設計 / プログラム / プロモーション：短期試作で課題を切り分け、実装まで一貫。
IoTプロダクトエンジニア（回路/組込みFW/Web）｜設計〜検証〜実装を一貫
回路/組込み/ユーザー体験まで一貫 -->
<!-- 試作から製品化・展示まで、プロダクトを体験として届けます -->

聞いて、整理して、作る。要件とプロダクトをつなぐエンジニアです。  
試作から製品化・展示まで、体験として仕上げます。  
<dl class="profile-grid">
  <dt>実務</dt><dd>ODM/受託（e-lamp）</dd>
  <dt>掲載</dt><dd>@DIME・ステレオ時代neo</dd>
