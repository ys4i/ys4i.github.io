...
## 実績・経歴
<dl class="profile-grid">
  <dt>実務経験</dt><dd>「e-lamp」他IoT機器開発</dd>
...
## スキル・強み
回路・ソフトウェアからユーザーへの伝え方までを見据えた設計能力  
要件定義から量産・製品化までやり切る完遂力  
...
<p class="caption-note">※ODM供給: 他社ブランド製品を、設計から量産まで一括で受託して供給すること<br>※秘密保持契約(NDA)により、取引先名/型番/数量などの詳細を公開できない案件・実績が複数あります。面談などでは開示可能範囲で担当範囲・設計意図・成果を説明可能です。</p>
